...
- (void)albumButtonClicked{
    ...
    MAGAlbumFactory *factory = [[MAGAlbumFactory alloc] init];
    [factory openRegularAlbumWithParentVC:self];
}
...
- (UIButton *)albumButton
{
    if (!_albumButton) {
        ...
        _albumButton.backgroundColor = [UIColor greenColor];
