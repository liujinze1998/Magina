//
//  MAGSettingsDefines.h
//  Magina
//
//  Created by AM on 2021/3/3.
//
...
NSString *const kPushSelector = @"selectorPush";
...
NSString *const kBooleanCheck = @"booleanCheck";
NSString *const kBooleanSwitch = @"booleanSwitch";
